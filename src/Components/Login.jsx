        ...
        <div className="bg-gray-900 min-h-screen flex flex-col">
            ...
            <main className="relative isolate px-6 pt-14 lg:px-8 flex-grow flex flex-col items-center justify-center">
                <div className="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80" aria-hidden="true">
                    <div className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-purple-500 to-blue-600 opacity-40 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
